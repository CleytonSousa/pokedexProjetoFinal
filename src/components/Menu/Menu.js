        ...
        <>
            <MenuRocket>
                ...
                <div className={active ? 'navRespo' : 'noShow'} id="navRespo">
                    ...
                    <Link data-testid='geracao' id={props.geracao} className="navItem" to="/geracao">GERAÇÃO</Link>
                    <Link data-testid='categorias' id={props.categorias} className="navItem" to='/categorias'>CATEGORIA</Link>
                    <Link data-testid='sobre' id={props.sobre} className="navItem" to='/sobre'>SOBRE</Link>
                <input id="menu__toggle" type="checkbox" />

                <label onClick={() => toggleMode()} className="menu__btn" htmlFor="menu__toggle">
